...
COPY mysanpete.bundle (id, bundle_name, final_price, start_date, end_date) FROM stdin;
\.
...
COPY mysanpete.bundle_voucher (id, voucher_id, bundle_id) FROM stdin;
\.
...
COPY mysanpete.user_voucher (id, user_id, voucher_id, final_price, isused, times_claimd, total_reclaimable) FROM stdin;
\.
